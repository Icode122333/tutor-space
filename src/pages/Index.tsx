...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button onClick={() => navigate("/auth")} className="bg-gradient-to-r from-green-500 to-green-600 hover:opacity-90">
              Sign Up
            </Button>
          </div>
        </div>
      ...
      {/* Hero Section */}
      <section id="home" className="relative overflow-hidden bg-gradient-to-br from-green-50 via-background to-green-100">
        {/* Decorative Shapes */}
        <div className="absolute top-20 right-10 w-32 h-32 bg-green-400/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-10 w-40 h-40 bg-green-500/20 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/4 w-20 h-20 bg-green-400/30 rounded-full"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  ...
                  <span className="relative">
                    faster with
                    <div className="absolute -inset-2 bg-gradient-to-r from-green-400 to-green-600 rounded-lg opacity-20 blur-lg"></div>
                  </span>
                  <br />
                  <span className="inline-block mt-2 px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-full">
                    DataPlus
                  </span>
                </h1>
              ...
              <div className="flex items-center gap-4">
                <Button size="lg" onClick={() => navigate("/auth")} className="bg-gradient-to-r from-green-500 to-green-600 hover:opacity-90">
                  Get Started
                </Button>
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-green-400/20 to-green-600/20 rounded-full blur-2xl"></div>
              <img 
                src={heroImage} 
              ...
              <div className="absolute bottom-8 left-8 bg-card/90 backdrop-blur-sm p-4 rounded-xl shadow-lg border">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-green-500 to-green-600"></div>
                  <div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <p className="text-center text-sm text-muted-foreground mb-8">Powered by DataPlus Technology</p>
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-50">
            <div className="text-2xl font-bold text-green-600">DataPlus</div>
            <div className="text-2xl font-bold text-green-600">DataPlus Analytics</div>
            <div className="text-2xl font-bold text-green-600">DataPlus Learning</div>
            <div className="text-2xl font-bold text-green-600">DataPlus Solutions</div>
            <div className="text-2xl font-bold text-green-600">DataPlus Academy</div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  "DataPlus has transformed my understanding of data analytics. The courses are comprehensive and practical!"
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-green-600"></div>
                  <div>
                    <div className="font-semibold text-sm">Uwimana Aline</div>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-green-600"></div>
                  <div>
                    <div className="font-semibold text-sm">Nkurunziza Jean</div>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  "I love how DataPlus makes complex data concepts easy to understand. Highly recommended!"
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-green-600"></div>
                  <div>
                    <div className="font-semibold text-sm">Mukamana Grace</div>
                    <div className="text-xs text-muted-foreground">Business Analyst</div>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-gradient-to-r from-green-500 to-green-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" variant="secondary" onClick={() => navigate("/auth")} className="bg-white text-green-600 hover:bg-white/90">
            Get Started Today
          </Button>
        </div>
      </section>
