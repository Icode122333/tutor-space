        ...
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border border-white/20">
          <div className="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <button onClick={() => navigate("/exhibition")} className="text-sm font-medium text-black hover:text-[#6BDB4A] transition-colors">Exhibition</button>
            </div>
            <div className="flex items-center gap-3">
              <Button
                variant="outline"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-white rounded-3xl">
              <div className="absolute inset-0 bg-gradient-to-br from-[#6BDB4A]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <CardContent className="pt-8 pb-8 px-6 relative z-10">
                ...
                <h3 className="font-bold text-xl mb-3 text-gray-900 text-center group-hover:text-[#6BDB4A] transition-colors duration-300">
                  Course Management
                </h3>
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative w-48 h-48 flex items-center justify-center">
                    ...
                    <div className="relative bg-white rounded-2xl p-8 shadow-md">
                      <FileText className="h-20 w-20 text-[#6BDB4A]" />
                    </div>
                  </div>
                </div>
                <h3 className="font-bold text-xl mb-3 text-gray-900 text-center group-hover:text-[#6BDB4A] transition-colors duration-300">
              ...
              <CardContent className="pt-8 pb-8 px-6 relative z-10">
                <div className="flex justify-center mb-6">
                  <div className="relative w-48 h-48 flex items-center justify-center">
                    <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-50 rounded-2xl transform -rotate-6 group-hover:-rotate-12 transition-transform duration-500"></div>
                    <div className="relative bg-white rounded-2xl p-8 shadow-md">
                      <MessageSquare className="h-20 w-20 text-[#6BDB4A]" />
                    </div>
                  </div>
                </div>
                <h3 className="font-bold text-xl mb-3 text-gray-900 text-center group-hover:text-[#6BDB4A] transition-colors duration-300">
              ...
              <CardContent className="pt-8 pb-8 px-6 relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-8 max-w-4xl mx-auto">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h3 className="font-bold text-2xl mb-4 text-gray-900 group-hover:text-[#6BDB4A] transition-colors duration-300">
                      Capstone Project
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                      <span className="px-4 py-2 bg-[#6BDB4A]/10 text-[#6BDB4A] rounded-full text-sm font-medium">
                        Real-world Projects
                      </span>
                      <span className="px-4 py-2 bg-[#6BDB4A]/10 text-[#6BDB4A] rounded-full text-sm font-medium">
                        Industry Standards
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
            <div className="flex gap-6 animate-scroll-rtl">
              ...
              <div className="flex-shrink-0 w-[350px] bg-[#5BC73A] rounded-3xl p-8 relative shadow-lg">
                <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#6BDB4A] to-[#5BC73A] border-4 border-white"></div>
                </div>
                <div className="mt-8">
              ...
              <div className="flex-shrink-0 w-[350px] bg-white rounded-3xl p-8 relative border-2 border-[#6BDB4A] shadow-lg">
                <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-green-100 to-green-200 border-4 border-white"></div>
                </div>
                <div className="mt-8">
                  <div className="text-[#6BDB4A] text-5xl font-bold mb-4">"</div>
                  ...
                  <div className="flex gap-1 justify-center">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="h-5 w-5 fill-[#6BDB4A] text-[#6BDB4A]" />
                    ))}
                  </div>
                </div>
              </div>
              ...
              <div className="flex-shrink-0 w-[350px] bg-white rounded-3xl p-8 relative border-2 border-green-200 shadow-lg">
                <div className="absolute -top-12 left-1/2 transform -translate-x-1/2">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#6BDB4A] to-green-300 border-4 border-white"></div>
                </div>
                <div className="mt-8">
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-8">
              ...
              <div className="md:col-span-1">
                ...
                <div className="flex items-center gap-4">
                  <a href="#" className="text-gray-600 hover:text-[#6BDB4A] transition-colors">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="#courses" className="text-sm text-gray-600 hover:text-[#6BDB4A] transition-colors">
                      Courses
                    </a>
                  </li>
                  <li>
                    <a href="#" className="text-sm text-gray-600 hover:text-[#6BDB4A] transition-colors">
                      Pricing
                    </a>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="#about" className="text-sm text-gray-600 hover:text-[#6BDB4A] transition-colors">
                      About
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#contact" className="text-sm text-gray-600 hover:text-[#6BDB4A] transition-colors">
                      Contact
                    </a>
                  </li>
                  <li>
