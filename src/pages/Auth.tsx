      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md space-y-4">
          ...
          <Button
            ...
            className="w-full h-11 text-sm font-medium bg-white border border-gray-300 hover:bg-gray-50 rounded-lg"
          >
          ...
          <form onSubmit={handleSignIn} className="space-y-3">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-black hover:bg-gray-800 text-white font-medium rounded-lg"
            >
